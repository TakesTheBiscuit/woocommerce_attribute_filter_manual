 ...
 */
class WC_Widget_Layered_Nav_Manual extends WC_Widget {

	/**
	 * Constructor.
	 */
	public function __construct() {
		$this->widget_cssclass    = 'woocommerce widget_layered_nav woocommerce-widget-layered-nav woocommerce-widget-layered-nav-manual';
		$this->widget_description = __( 'Display a list of attributes to filter products in your store. Manual apply.');
		$this->widget_id          = 'woocommerce_layered_nav_manual';
		$this->widget_name        = __( 'Filter Products by Attribute Manual Apply');
		parent::__construct();
	}
		...
		if ( $taxonomy !== $this->get_current_taxonomy() ) {
			...
			wc_enqueue_js(
				...
				jQuery( '.dropdown_layered_nav_" . esc_js( $taxonomy_filter_name ) . "' ).on( 'change', function() {
					...
					// Modification # 1 to original code
